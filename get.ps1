...
Write-Host "           GamerX Script               " -ForegroundColor Magenta
Write-Host "======================================" -ForegroundColor Cyan
Write-Host
Write-Host "  Github Link: https://github.com/GraphicsAndroid65" -ForegroundColor Blue
Write-Host
Write-Host "  [*] Activate Windows & Windows 365 For Free (Support Windows 10 & 11)" -ForegroundColor Yellow
Write-Host "  [*] Contect Me - https://t.me/GamerX3560" -ForegroundColor Green
Write-Host
